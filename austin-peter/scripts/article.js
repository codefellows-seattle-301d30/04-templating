...
// In the sort() method, the function is taking two parameters, thus needing parenthesis. In the forEach() method, there is only one parameter so the arrow function doesn't need to enclose it in parenthesis.
rawData.sort((a,b) => {
