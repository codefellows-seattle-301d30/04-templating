...
// You can remove the parentheses around arguments when you use arrow functions if there is only one argument. Since a and b are both arguments, the parentheses are necessary.
rawData.sort((a,b) => {
